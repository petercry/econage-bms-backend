...
public class BmsProjectEventEntity extends BaseEntity {
    private String id;
    ...
    private LocalDate checkDate;//在"进度检查"中，是"检查时间"
    ...
    private String taxType;//财务收款中。税费类别(产品、服务、小规模)
    private Double valueAddedTaxAmt;//财务收款中。增值税金额
    private Double superTaxAmt;//财务收款中。附加税金额
    private Double stampTaxAmt;//财务收款中。印花税金额
    ...
    public Double getValueAddedTaxAmt() {
        return valueAddedTaxAmt;
    }

    public void setValueAddedTaxAmt(Double valueAddedTaxAmt) {
        this.valueAddedTaxAmt = valueAddedTaxAmt;
    }

    public Double getSuperTaxAmt() {
        return superTaxAmt;
    }

    public void setSuperTaxAmt(Double superTaxAmt) {
        this.superTaxAmt = superTaxAmt;
    }
    ...
    public void setStampTaxAmt(Double stampTaxAmt) {
        this.stampTaxAmt = stampTaxAmt;
    }
